...
class ProjectTableTest extends PHPUnit_Framework_TestCase
{
    ...
    {
    	$projectData = array('name' => 'The Military Wives', 'description' => 'In My Dreams');
    	$project     = new Project();
    ...
    {
    	$projectData = array('idproject' => 123, 'name' => 'The Military Wives', 'description' => 'In My Dreams');
    	$project     = new Project();
    	$project->exchangeArray($projectData);
    	...
    	$mockTableGateway->expects($this->once())
    	->method('update')
    	->with(array('name' => 'The Military Wives', 'description' => 'In My Dreams'),
    			array('idproject' => 123));
